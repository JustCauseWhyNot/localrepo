...
EGIT_REPO_URI="https://github.com/sharkautarch/gamescope.git"
EGIT_BRANCH="nvidia-fix-latest-upstream"
inherit git-r3
KEYWORDS="~amd64"
LICENSE="BSD-2"
SLOT="0"
...
src_configure() {
	local emesonargs=(
		...
		-Dforce_fallback_for=stb,wlroots,vkroots,wayland,libliftoff
